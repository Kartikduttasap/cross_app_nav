					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cross App Navigation App",
									"targetURL": "#nscrossapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nscrossapp-display": {
								"semanticObject": "nscrossapp",
								"action": "display",
								"description": "Cross App Navigation App",
								"title": "Cross App Navigation App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.crossapp",
									"url": sap.ui.require.toUrl("ns/crossapp")
								}
							}
						}
					}
